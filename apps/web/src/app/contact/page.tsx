    ...
    <div className="bg-background min-h-screen">
      ...
      <main className="px-4 sm:px-8 lg:px-16 py-6 sm:py-8 lg:py-10">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6 items-start">
          <div className="bg-white rounded-xl soft-card card-hover p-6">
            ...
            <form onSubmit={(e) => e.preventDefault()} className="space-y-4">
              <div>
                ...
                <input type="text" placeholder="Your name" className="w-full border rounded-xl px-3 py-2 text-sm" />
              </div>
              <div>
                <label className="text-sm font-medium block mb-1">Email</label>
                <input type="email" placeholder="you@example.com" className="w-full border rounded-xl px-3 py-2 text-sm" />
              </div>
              <div>
                <label className="text-sm font-medium block mb-1">Subject</label>
                <input type="text" placeholder="What is this about?" className="w-full border rounded-xl px-3 py-2 text-sm" />
              </div>
              <div>
                <label className="text-sm font-medium block mb-1">Message</label>
                <textarea rows={4} className="w-full border rounded-xl px-3 py-2 text-sm"></textarea>
              </div>
              <button type="submit" className="bg-primary-green text-white font-semibold shadow-sm hover:shadow-md hover:bg-dark-green px-5 py-2 rounded-xl">
                Send Message
              </button>
            </form>
          </div>
