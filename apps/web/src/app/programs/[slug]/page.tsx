  ...
  return (
    <div className="min-h-screen bg-bg-light">
      ...
      <main className="mx-4 sm:mx-8 lg:mx-[64px] my-8">
        ...
        <div
          className="relative rounded-xl p-8 sm:p-12 mb-12 overflow-hidden"
          style={{ backgroundColor: bgColor }}
        >
          <div className="relative z-10">
            {program.kannadaName && (
              <h1 className="text-3xl sm:text-[48px] font-bold text-white mb-3 tracking-tight">
                {program.kannadaName}
              </h1>
            )}
            <h2 className="text-xl sm:text-[28px] font-semibold text-white mb-3 tracking-tight">
              {program.name}
            </h2>
            <p className="text-base sm:text-[18px] text-white/90">
              {program.schedule}
            </p>
          </div>
        ...
        <div className="mb-12">
          <h2 className="text-2xl sm:text-[30px] font-bold text-gray-900 mb-6 tracking-tight">Latest Episodes</h2>
          ...
          {episodes.length === 0 ? (
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-[24px]">
              {episodes.map((episode) => (
                <div
                  key={episode.number}
                  className="bg-white rounded-2xl soft-card card-hover overflow-hidden border border-gray-100 hover:shadow-lg transition-shadow"
                >
